...
### 要点
	...
	登录用户uid: `root`
	密码密文passwd: `e10adc3949ba59abbe56e057f20f883e`
	校验token: MD5(uid+passwd+uid).toUpperCase（转大写）
	当前时间: 北京时间 2015/12/21 18:02:18 unixtimestamp: `1450692138`
	当值为JSON对象时，需要字符串化
	每个值都需要URIEncode
...
**基础数据**：
  ...
  - timestamp = `1530272496`
  - 控制码是 `123456`, SHA1加密取十六进制(hex)码大写为：`7C4A8D09CA3762AF61E59520943DC26494F8941B`
...
**加密步骤**：
  ...
  5. plainText = `2983c70209011de8bb608b381d2b5283fe2e0212ca=%25%25command=EMC_SWITCHctrlcode=7C4A8D09CA3762AF61E59520943DC26494F8941Bcz=3p=userAparam=%7B%22mode%22%3A%22EMC_OFF%22%7Dt=D4AB3F48C42A65DF8F425AB55B501FF82983c70209011de8bb608b381d2b5283fe2e0212`
