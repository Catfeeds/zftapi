...
function test_deploy() {
  ...
  docker run -e AMAPKEY -e ZFT_RDS_HOST -e ZFT_RDS_PORT -e ZFT_RDS_USERNAME -e ZFT_RDS_PASSWORD -e ZFT_RDS_DATABASE -d --name test_api_deploy -p 8090:8000 $REPO:$IMAGE_VERSION
}
