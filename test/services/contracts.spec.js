...
describe('Contracts', function() {
    ...
    it('should allow to filter contracts if leasing status is overdue', async function() {
        const req = {
            params: {
                projectId: 100,
            },
    ...
    it('should allow to filter contracts if leasing status is leasing', async function() {
        const req = {
            params: {
                projectId: 100,
            },
